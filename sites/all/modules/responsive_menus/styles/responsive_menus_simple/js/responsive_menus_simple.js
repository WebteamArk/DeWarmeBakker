  ...
  Drupal.behaviors.responsive_menus = {
    attach: function (context, settings) {
      ...
      $('body').once('responsive-menus-load', function() {
        ...
        var windowWidth = getScrollBarDimensions().vertical + (document.documentElement.clientWidth || document.body.clientWidth);
        ...
        $(window).resize(function() {
          // Window width with legacy browsers.
          windowWidth = getScrollBarDimensions().vertical + (document.documentElement.clientWidth || document.body.clientWidth);
